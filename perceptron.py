...
# SPECIFICATION: This program trains train a Single Layer Perceptron and a 
# Multi-Layer Perceptron to classify optically recognized handwritten digits
...
for learning_rate in n: #iterates over n
    ...
    for shuffle_val in r : #iterates over r
        ...
        for model in ['Perceptron', 'MLP']: #iterates over the algorithms
            ...
            #-->add your Pyhton code here
            if model == 'Perceptron':
                clf = Perceptron(eta0 = learning_rate, shuffle = shuffle_val, max_iter=1000)
            else:
                clf = MLPClassifier(activation='logistic', learning_rate_init = learning_rate, hidden_layer_sizes = 25, shuffle = shuffle_val, max_iter=1000)
            ...
            if model == 'Perceptron' and accuracy > highest_perceptron_accuracy:
                ...
                print(f"Highest Perceptron accuracy so far: {accuracy:.3f}, Parameters: learning rate={learning_rate}, shuffle={shuffle_val}")
            elif model == 'MLP' and accuracy > highest_mlp_accuracy:
                highest_mlp_accuracy = accuracy
                print(f"Highest MLP accuracy so far: {accuracy:.3f}, Parameters: learning rate={learning_rate}, shuffle={shuffle_val}")
